...
export default async function Page() {
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <h1 className="text-4xl font-bold mb-4">1 Bedroom in Kenya - Apartments & Houses</h1>
      <p className="text-lg text-muted-foreground mb-8">Browse {properties.length}+ 1 bedroom properties in Kenya. Perfect for singles, couples & young professionals.</p>
      {properties.length > 0 ? (
        <>
          ...
          <div className="text-center">
            <Button asChild size="lg">
              <Link href="/search?beds=1">View All 1 Bedroom Properties</Link>
            </Button>
          </div>
        </>
      ) : (
