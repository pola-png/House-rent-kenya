...
export default async function Page() {
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <h1 className="text-4xl font-bold mb-4">Homes for Sale in Kenya - Real Estate Properties</h1>
      <p className="text-lg text-muted-foreground mb-8">Find {properties.length}+ homes for sale in Kenya. Houses, apartments, condos & luxury properties available nationwide.</p>
      {properties.length > 0 ? (
        <>
          ...
          <div className="text-center">
            <Button asChild size="lg">
              <Link href="/search?type=sale">View All Homes for Sale</Link>
            </Button>
          </div>
        </>
      ) : (
