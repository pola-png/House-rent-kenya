...
export default async function Page() {
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <h1 className="text-4xl font-bold mb-4">New Homes for Sale in Kenya - Latest Listings</h1>
      <p className="text-lg text-muted-foreground mb-8">Explore {properties.length}+ new homes for sale in Kenya. Latest property listings & new developments from trusted builders.</p>
      {properties.length > 0 ? (
        <>
          ...
          <div className="text-center">
            <Button asChild size="lg">
              <Link href="/search?type=sale">View All New Homes</Link>
            </Button>
          </div>
        </>
      ) : (
