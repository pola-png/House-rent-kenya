...
export default async function Page() {
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <h1 className="text-4xl font-bold mb-4">Buy a House in Kenya - Your Home Purchase Journey</h1>
      <p className="text-lg text-muted-foreground mb-8">Ready to buy a house in Kenya? Browse {properties.length}+ verified properties for sale with expert guidance & trusted agents.</p>
      {properties.length > 0 ? (
        <>
          ...
          <div className="text-center">
            <Button asChild size="lg">
              <Link href="/search?type=sale">Start Your Home Buying Journey</Link>
            </Button>
          </div>
        </>
      ) : (
