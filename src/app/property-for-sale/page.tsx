  ...
  return (
    <>
      ...
      <PromotedPropertiesLayout
        ...
        description={`Discover ${all.length}+ properties for sale. Apartments, houses, land & commercial real estate with verified listings and investment opportunities across Kenya.`}
