...
export default async function Page() {
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <h1 className="text-4xl font-bold mb-4">Real Estate Listings Kenya - Property Database</h1>
      <p className="text-lg text-muted-foreground mb-8">Access {properties.length}+ verified real estate listings in Kenya. Complete property database for rent & sale.</p>
      {properties.length > 0 ? (
        <>
