...
export default function SignupPage() {
  ...
  return (
    <div className="w-full lg:grid lg:min-h-[calc(100vh-5rem)] lg:grid-cols-2 xl:min-h-[calc(100vh-5rem)] bg-gradient-to-br from-background to-muted/20">
      <div className="flex items-center justify-center py-12 px-4">
        <Card className="mx-auto max-w-md w-full shadow-2xl border-0 bg-white/90 backdrop-blur-sm">
          <CardHeader className="space-y-1 pb-6">
            ...
            <CardDescription className="text-center">Join thousands finding their perfect home</CardDescription>
          </CardHeader>
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem className="grid gap-2">
                        ...
                        <FormControl>
                          <Input placeholder="John" className="h-11" {...field} disabled={isSubmitting}/>
                        </FormControl>
                        <FormMessage />
                      </FormItem>
                    )}
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem className="grid gap-2">
                      ...
                      <FormControl>
                        <Input type="email" placeholder="john@example.com" className="h-11" {...field} disabled={isSubmitting}/>
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
      ...
      <div className="hidden bg-gradient-to-br from-blue-500 via-indigo-600 to-purple-700 lg:block relative overflow-hidden">
        {bgImage && (
          <Image
        ...
        <div className="absolute inset-0 bg-gradient-to-br from-blue-500/90 via-indigo-600/90 to-purple-700/90 flex flex-col justify-between p-12 text-white">
          ...
          <div className="max-w-lg">
            <h2 className="text-5xl font-bold font-headline mb-6 leading-tight">Find Your Dream Home</h2>
            <p className="text-xl text-white/90 leading-relaxed mb-8">Join our community of property seekers and get access to exclusive listings, personalized recommendations, and instant alerts.</p>
