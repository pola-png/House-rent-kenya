        ...
        <section className="py-12 md:py-20 bg-secondary/50" itemScope itemType="https://schema.org/Service">
          <div className="container mx-auto px-4">
            ...
            <div className="space-y-12">
              <div className="text-center max-w-3xl mx-auto">
                <h3 className="text-2xl sm:text-3xl md:text-4xl font-headline font-bold mb-4 px-4">Why Choose Rental Properties in Kenya</h3>
              ...
              <div className="text-center max-w-3xl mx-auto">
                <h3 className="text-2xl sm:text-3xl md:text-4xl font-headline font-bold mb-4 px-4">Why Choose House Rent in Kenya</h3>
                <p className="text-muted-foreground text-lg">
              ...
              <div className="text-center max-w-3xl mx-auto">
                <h3 className="text-2xl sm:text-3xl md:text-4xl font-headline font-bold mb-4 px-4">Why Choose Houses for Rent in Kenya</h3>
                <p className="text-muted-foreground text-lg">
              ...
              <div className="text-center max-w-3xl mx-auto">
                <h3 className="text-2xl sm:text-3xl md:text-4xl font-headline font-bold mb-4 px-4">Why Choose House Rent in Nairobi</h3>
                <p className="text-muted-foreground text-lg">
              ...
              <div className="text-center max-w-3xl mx-auto">
                <h3 className="text-2xl sm:text-3xl md:text-4xl font-headline font-bold mb-4 px-4">Why Choose a Bedsitter for Rent in Kasarani</h3>
                <p className="text-muted-foreground text-lg">
              ...
              <div className="text-center max-w-3xl mx-auto">
                <h3 className="text-2xl sm:text-3xl md:text-4xl font-headline font-bold mb-4 px-4">Why Choose 2 Bedroom Rent in Kenya</h3>
                <p className="text-muted-foreground text-lg">
              ...
              <div className="text-center max-w-3xl mx-auto">
                <h3 className="text-2xl sm:text-3xl md:text-4xl font-headline font-bold mb-4 px-4">Why Choose 3 Bedroom Rent in Kenya</h3>
                <p className="text-muted-foreground text-lg">
              ...
              <div className="text-center max-w-3xl mx-auto">
                <h3 className="text-2xl sm:text-3xl md:text-4xl font-headline font-bold mb-4 px-4">Why Choose a 1 Bedroom in Kisumu</h3>
                <p className="text-muted-foreground text-lg">
              ...
              <div className="text-center max-w-3xl mx-auto">
                <h3 className="text-2xl sm:text-3xl md:text-4xl font-headline font-bold mb-4 px-4">Why Choose a 2 Bedroom in Mombasa</h3>
                <p className="text-muted-foreground text-lg">
              ...
              <div className="text-center max-w-3xl mx-auto">
                <h3 className="text-2xl sm:text-3xl md:text-4xl font-headline font-bold mb-4 px-4">Why Choose Properties for Sale in Kenya</h3>
                <p className="text-muted-foreground text-lg">
              ...
              <div className="text-center max-w-3xl mx-auto">
                <h3 className="text-2xl sm:text-3xl md:text-4xl font-headline font-bold mb-4 px-4">Why Choose Real Estate for Sale in Kenya</h3>
                <p className="text-muted-foreground text-lg">
              ...
              <div className="text-center max-w-3xl mx-auto">
                <h3 className="text-2xl sm:text-3xl md:text-4xl font-headline font-bold mb-4 px-4">Why Choose Homes for Sale in Kenya</h3>
                <p className="text-muted-foreground text-lg">
              ...
              <div className="text-center max-w-3xl mx-auto">
                <h3 className="text-2xl sm:text-3xl md:text-4xl font-headline font-bold mb-4 px-4">Why Choose Houses for Sale in Kenya</h3>
                <p className="text-muted-foreground text-lg">
              ...
              <div className="text-center max-w-3xl mx-auto">
                <h3 className="text-2xl sm:text-3xl md:text-4xl font-headline font-bold mb-4 px-4">Why Choose Property for Sale in Kenya</h3>
                <p className="text-muted-foreground text-lg">
