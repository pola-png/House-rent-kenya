...
export default function HouseRentKenyaPage() {
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <p className="text-lg text-muted-foreground mb-8">
        Discover 1000+ houses for rent across Kenya. Browse verified rental properties in Nairobi, Mombasa, Kisumu, Nakuru, and all major cities. Find apartments, family homes, bedsitters, and luxury villas with trusted agents.
      </p>
      ...
      {isLoading ? (
        ...
        <>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
            {properties.map((property) => <PropertyCard key={property} property={property} />)}
          </div>
          <div className="text-center">
            <Button asChild size="lg">
              <Link href="/search?type=rent">View All Houses for Rent</Link>
            </Button>
          </div>
        </>
      )}
